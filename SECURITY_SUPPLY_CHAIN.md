...
This repo treats dependency, workflow, source, and extension/tool changes as security-sensitive.
...
- Require review for `.github/workflows/`, `.github/actions/`, package manifests, lockfiles, `.npmrc`, TypeScript/JavaScript source, and extension/tool config.
